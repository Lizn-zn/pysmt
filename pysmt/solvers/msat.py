...
class MSatConverter(Converter, DagWalker):
    ...
    def _back_single_term(self, term, mgr, args):
        ...
        :param term: The self._msat_lib term to be transformed in pysmt formulae
        :type term: self._msat_lib term
    ...
    def convert(self, formula):
        """Convert a PySMT formula into a self._msat_lib Term.
    ...
    def _msat_type_to_type(self, tp):
        """Converts a self._msat_lib type into a PySMT type."""
